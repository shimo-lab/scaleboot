...
% $Id: usesb.Rnw,v 1.6 2006/11/14 15:08:10 shimo Exp shimo $
%%\VignetteIndexEntry{Multiscale Bootstrap using Scaleboot Package}
\def\documentid{\getTime-stamp: "2007-11-06 16:32:09 shimo"}
...
\thanks{This document is a part of the {\tt scaleboot} package (Version 0.3-1 or newer). The source file is usesb.Rnw (\documentid).
...
$p_3\approx41\%$; this is the AU $p$-value of Shimodaira (2008).  For
