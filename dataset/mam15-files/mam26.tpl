...
(Homsa,(Phovi,Bosta),Orycu,Musmu,Didvi); t0
((Homsa,(Phovi,Bosta),Orycu),Musmu,Didvi); ta
((Homsa,Orycu,Musmu),(Phovi,Bosta),Didvi); tb
(((Phovi,Bosta),Orycu,Musmu),Homsa,Didvi); tc
((Homsa,(Phovi,Bosta),Musmu),Orycu,Didvi); td
(Homsa,(Phovi,Bosta),(Orycu,Musmu,Didvi)); te
(Orycu,Musmu,(Homsa,(Phovi,Bosta),Didvi)); tf
((Phovi,Bosta),Musmu,(Homsa,Orycu,Didvi)); tg
(Homsa,Orycu,((Phovi,Bosta),Musmu,Didvi)); th
((Phovi,Bosta),Orycu,(Homsa,Musmu,Didvi)); ti
(Homsa,Musmu,((Phovi,Bosta),Orycu,Didvi)); tj
